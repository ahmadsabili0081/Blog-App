...
$uid = $_GET['uid'];
$user_folder = '../../../files/media' . $uid . '_files'; //result : media34_files,media2_files
$user_trash_folder_path = $user_folder . '/.trash';
...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => $user_folder,                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/' . $user_folder, // URL to files (REQUIRED)
