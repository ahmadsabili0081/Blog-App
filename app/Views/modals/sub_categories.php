<div class="modal fade" id="sub_categori_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content" id="sub_kategori" action="<?= base_url('admin/sub_kategori_submit'); ?>" method="post">
      <?= csrf_field(); ?>
